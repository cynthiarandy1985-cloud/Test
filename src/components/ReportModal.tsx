        ...
        <div className="overflow-y-auto max-h-[calc(90vh-200px)]" id="report-content">
          <div className="p-6 space-y-8">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 p-6 rounded-lg border border-pink-200 dark:border-pink-700">
              <h3 className="font-bold mb-4 text-xl flex items-center text-purple-800 dark:text-purple-300">
                <Heart className="w-6 h-6 mr-2" />
                What Your Scores Mean
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-slate-700 p-4 rounded-lg border border-pink-100 dark:border-pink-700">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">Ideas & Content ({data.criteria.ideasContent.score}/10) </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">{generateChildFriendlyExplanation("Ideas & Content", data.criteria.ideasContent.score)}</p>
                </div>
                <div className="bg-white dark:bg-slate-700 p-4 rounded-lg border border-pink-100 dark:border-pink-700">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">Structure & Organization ({data.criteria.structureOrganization.score}/10) </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">{generateChildFriendlyExplanation("Structure & Organization", data.criteria.structureOrganization.score)}</p>
                </div>
                <div className="bg-white dark:bg-slate-700 p-4 rounded-lg border border-pink-100 dark:border-pink-700">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">Language & Vocabulary ({data.criteria.languageVocab.score}/10) </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">{generateChildFriendlyExplanation("Language & Vocabulary", data.criteria.languageVocab.score)}</p>
                </div>
                <div className="bg-white dark:bg-slate-700 p-4 rounded-lg border border-pink-100 dark:border-pink-700">
                  <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">Spelling & Grammar ({data.criteria.spellingPunctuationGrammar.score}/10) </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300">{generateChildFriendlyExplanation("Spelling, Punctuation & Grammar", data.criteria.spellingPunctuationGrammar.score)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-slate-900 p-6 rounded-lg">
              <h3 className="font-bold mb-6 text-xl flex items-center dark:text-gray-200">
            ...
            {specificStrengths.length > 0 && (
              <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border border-green-200 dark:border-green-700">
                <h3 className="font-bold mb-4 text-xl flex items-center text-green-800 dark:text-green-300">
