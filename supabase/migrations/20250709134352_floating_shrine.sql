/*
  ...
  1. New Types
    - Conditionally create `stripe_subscription_status` enum if it doesn't exist
    - Conditionally create `stripe_order_status` enum if it doesn't exist
  
  This migration safely creates enum types by checking if they already exist first,
  preventing the "type already exists" error.
*/
