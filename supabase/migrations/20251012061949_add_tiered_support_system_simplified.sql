/*
  # Add Tiered Support System for AI Writing Buddy (Simplified)

  1. New Tables
    - `writing_buddy_preferences` - Stores student support level preferences
    - `tiered_feedback_history` - Stores all feedback with support level context  
    - `support_level_recommendations` - Stores system-generated recommendations
  ...
  3. Functions
    ...
    - Function to record feedback sessions
*/
